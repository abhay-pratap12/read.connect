    ...
    <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      ...
      <article className="flex max-w-2xl flex-col items-start justify-between">
        ...
        <div className="group">
          ...
          <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600"> The platform builds connections by implementing various features and strategies to foster user interaction and engagement. Here are some ways it builds connections</p>
        </div>
        <div className=" mt-8 flex items-center gap-x-4">
