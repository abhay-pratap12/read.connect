...
const Banner = ( ) => {
    return ( 
        <div className="bg-yellow-100 h-full lg:w-full w-screen flex justify-center text-[1.1rem]
         flex-wrap lg:flex-nowrap" >
            <div className="lg:w-4/6 px-8 text-gray-800 w-full">
                <h1 className="lg:pl-32 pl-1 mt-16 font-bold text-6xl">Welcome to our store</h1>
